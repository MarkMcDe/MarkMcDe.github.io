...
//Jan 9: Adding id tags to elements for better CSS formatting
    ...
    echo "<span style='timeTitle'><strong>" . $Gdate->format('g:i') . " ";
	$Ampm2 = ($Gend->format('a'));
...
//Inserts beer mug emoji
    ...
    echo " <strong>" . $decoded_response["items"][$i]["summary"] . "</strong></strong></span><br/>";
...
if ($shortcode > 0) $stripcity=substr($stripcity,0,$shortcode-1);
    ...
    echo json_decode('"\uD83C\uDF0E"');
    echo ("</a></span><br/>");
//    echo " <a href='https://www.google.com/maps/place/" . $stripcity . ">json_decode('"\uD83C\uDF7A"')</a></a>";
//end stripcity
